...
compute_dynseg_cpp <- function(suff_stats, family, ncol, max_blocks, pen_func) {
    .Call(`_blockcpd_compute_dynseg_cpp`, suff_stats, family, ncol, max_blocks, pen_func)
}

compute_hierseg_cpp <- function(suff_stats, family, ncol, pen_func) {
