...
### Simulating data 
  ...
  in four intervals: $[1, 50]$, $[51, 120]$, $[121, 180]$ and $[181, 200]$. We 
  ...
  of each block except the last, in our case $(50, 120, 180)$. 
...
```
  ...
  The user wants to plot the parameter against the variable directly, passing
  the variable values and name.
...
```
  ...
  are true change-points, but $120$ also has a high detection value near $70$%.
  Notice that the index $1$ was detected around $20$% of the time, which is due
  to chance. If we collected more signals, this value would increasingly 
  approach $0$.
